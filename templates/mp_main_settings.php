    ...
    <form method="post" action="" novalidate="novalidate" method="post">
        ...
        <table class="form-table" border="0.5" frame="above" rules="void">
            ...
            <tr>
                ...
                <td>
                    <input name="public_key" type="text" id="public_key" aria-describedby="tagline-description"
                           value="<?php form_option('_mp_public_key'); ?>" class="regular-text"/>
                    <p class="description" id="tagline-description">
            ...
            <tr>
                ...
                <td>
                    <input name="access_token" type="text" id="access_token" aria-describedby="tagline-description"
                           value="<?php form_option('_mp_access_token'); ?>" class="regular-text"/>
                    <p class="description" id="tagline-description">
            ...
            <?php if (!empty ($site_id_v1)) { ?>
                <tr>
                    <th scope="row"><label><?php echo __('Currency Conversion', 'woocommerce-mercadopago'); ?></label>
                    </th>
                    <td>
                        <label>
                            <input class="" type="checkbox" name="currency_conversion_v1"
                                   id="currency_conversion_v1" <?php echo $is_currency_conversion_v1; ?>>
                            <?php echo __('If the used currency in WooCommerce is different or not supported by Mercado Pago, convert values of your transactions using Mercado Pago currency ratio. This service may slow down your server as each conversion is made in the checkout moment.', 'woocommerce-mercadopago'); ?>
                        </label>
                        <p class="description" id="tagline-description">
        ...
        <table class="form-table" border="0.5" frame="above" rules="void">
            ...
            <tr>
                ...
                <td>
                    <input name="statement_descriptor" type="text" id="statement_descriptor"
                           aria-describedby="tagline-description" value="<?php echo $statement_descriptor; ?>"
                           class="regular-text"/>
                    <p class="description" id="tagline-description">
                        <?php echo esc_html(
            ...
            <tr>
                ...
                <td>
                    <input name="store_identificator" type="text" id="store_identificator"
                           aria-describedby="tagline-description" value="<?php echo $store_identificator; ?>"
                           class="regular-text"/>
                    <p class="description" id="tagline-description">
                        <?php echo esc_html(
            ...
            <tr>
                <th scope="row">
                    <label><?php echo __('Custom banner for checkout', 'woocommerce-mercadopago'); ?></label></th>
                <td>
                    <input name="custom_banner" type="text" id="custom_banner" aria-describedby="tagline-description"
                           value="<?php echo $custom_banner; ?>" class="regular-text"/>
                    <p class="description" id="tagline-description">
                        <?php echo esc_html(
            ...
            <tr>
                ...
                <td>
                    <input name="custom_domain" type="text" id="custom_domain" aria-describedby="tagline-description"
                           value="<?php echo $custom_domain; ?>" class="regular-text"/>
                    <p class="description" id="tagline-description">
            ...
            <tr>
                ...
                <td>
                    <input name="sponsor_id" type="text" id="sponsor_id" aria-describedby="tagline-description"
                           value="<?php echo $sponsor_id; ?>" class="regular-text"/>
                    <p class="description" id="tagline-description">
