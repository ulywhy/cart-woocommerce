    ...
    <div id="mercadopago-form-ticket" class="mp-box-inputs mp-line">
        <div id="form-ticket">
            <div class="form-row" style="height:24px; margin-bottom: 12px;">
                ...
                <div class="form-col-6">
                    <input type="radio" name="mercadopago_ticket[docType]" class="MPv1Ticket-docType"
                           id="MPv1Ticket-docType-fisica" value="CPF" style="width:24px; height:24px;"
                           checked="checked">
            ...
            <div class="form-row">
                <div class="form-col-4" id="box-firstname">
                    <label for="firstname"
                           class="title-name"><?php echo esc_html__('NAME', 'woocommerce-mercadopago'); ?><em
                                class="obrigatorio"> *</em></label>
                    <label for="firstname"
                           class="title-razao-social"><?php echo esc_html__('SOCIAL NAME', 'woocommerce-mercadopago'); ?>
                        <em class="obrigatorio"> *</em></label>
                    <input type="text" value="<?php echo $febraban['firstname']; ?>"
                           id="firstname" class="form-control-mine" name="mercadopago_ticket[firstname]">
                    <span class="erro_febraban" data-main="#firstname"
                          id="error_firstname"><?php echo esc_html__('You must inform you NAME', 'woocommerce-mercadopago'); ?></span>
                </div>
                <div class="form-col-4" id="box-lastname">
                    <label for="lastname"><?php echo esc_html__('SURNAME', 'woocommerce-mercadopago'); ?><em
                                class="obrigatorio"> *</em></label>
                    <input type="text" value="<?php echo $febraban['lastname']; ?>"
                           id="lastname" class="form-control-mine" name="mercadopago_ticket[lastname]">
                    <span class="erro_febraban" data-main="#lastname"
                          id="error_lastname"><?php echo esc_html__('You must inform your SURNAME', 'woocommerce-mercadopago'); ?></span>
                </div>
                <div class="form-col-4" id="box-docnumber">
                    <label for="cpfcnpj"
                           class="title-cpf"><?php echo esc_html__('DOCUMENT', 'woocommerce-mercadopago'); ?><em
                                class="obrigatorio"> *</em></label>
                    <label for="cpfcnpj" class="title-cnpj"><?php echo esc_html__('CNPJ', 'woocommerce-mercadopago'); ?>
                        <em class="obrigatorio"> *</em></label>
                    ...
                    <span class="erro_febraban" data-main="#cpfcnpj"
                          id="error_docNumber"><?php echo esc_html__('You must inform your DOCUMENT', 'woocommerce-mercadopago'); ?></span>
                </div>
            </div>
            <div class="form-row">
                <div class="form-col-8">
                    <label for="address"><?php echo esc_html__('ADDRESS', 'woocommerce-mercadopago'); ?><em
                                class="obrigatorio"> *</em></label>
                    <input type="text" value="<?php echo $febraban['address']; ?>"
                           id="address" class="form-control-mine" name="mercadopago_ticket[address]">
                    <span class="erro_febraban" data-main="#address"
                          id="error_address"><?php echo esc_html__('You must inform your ADDRESS', 'woocommerce-mercadopago'); ?></span>
                </div>
                <div class="form-col-4">
                    <label for="number"><?php echo esc_html__('NUMBER', 'woocommerce-mercadopago'); ?><em
                                class="obrigatorio"> *</em></label>
                    <input type="text" value="<?php echo $febraban['number']; ?>"
                           id="number" class="form-control-mine" name="mercadopago_ticket[number]">
                    <span class="erro_febraban" data-main="#number"
                          id="error_number"><?php echo esc_html__('You must inform your ADDRESS NUMBER', 'woocommerce-mercadopago'); ?></span>
                </div>
            </div>
            <div class="form-row">
                <div class="form-col-4">
                    <label for="city"><?php echo esc_html__('CITY', 'woocommerce-mercadopago'); ?><em
                                class="obrigatorio"> *</em></label>
                    <input type="text" value="<?php echo $febraban['city']; ?>"
                           id="city" class="form-control-mine" name="mercadopago_ticket[city]">
                    <span class="erro_febraban" data-main="#city"
                          id="error_city"><?php echo esc_html__('You must inform your CITY', 'woocommerce-mercadopago'); ?></span>
                </div>
                <div class="form-col-4">
                    <label for="state"><?php echo esc_html__('STATE', 'woocommerce-mercadopago'); ?><em
                                class="obrigatorio"> *</em></label>
                    <select name="mercadopago_ticket[state]" id="state" class="form-control-mine" style="width: 100%;">
                        ...
                        } ?>><?php echo esc_html__('Choose', 'woocommerce-mercadopago'); ?></option>
                    ...
                    <span class="erro_febraban" data-main="#state"
                          id="error_state"><?php echo esc_html__('You must inform your STATE', 'woocommerce-mercadopago'); ?></span>
                </div>
                <div class="form-col-4">
                    <label for="zipcode"><?php echo esc_html__('ZIP', 'woocommerce-mercadopago'); ?><em
                                class="obrigatorio"> *</em></label>
                    <input type="text" value="<?php echo $febraban['zipcode']; ?>"
                           id="zipcode" class="form-control-mine" name="mercadopago_ticket[zipcode]">
                    <span class="erro_febraban" data-main="#zipcode"
                          id="error_zipcode"><?php echo esc_html__('You must inform your ZIP', 'woocommerce-mercadopago'); ?></span>
                </div>
            </div>
            <label>
        ...
        <div>
            ...
            <div class="mp-box-inputs mp-col-100" id="mercadopago-utilities">
                ...
                <input type="hidden" id="currency_ratioTicket" value="<?php echo $currency_ratio; ?>"
