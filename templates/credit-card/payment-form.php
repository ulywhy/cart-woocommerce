    ...
    <div class="col-md-12">
      <div class="frame-tarjetas">
        ...
        <div id="mercadopago-form-customer-and-card">
          <label for="paymentMethodIdSelector"><?= esc_html__( 'Payment Method', 'woocommerce-mercadopago' ); ?> <em>*</em></label>
        ...
        <!-- END TODO: VERIFICAR ESSES CAMPOS -->
        ...
        <div id="mercadopago-form">
          ...
          <div class="row pt-10">
            <div class="col-md-6 pr-25">
              ...
              <span class="mp-error" id="mp-error-208" data-main="#cardExpirationDate"><?= esc_html__( 'Invalid Expiration Date', 'woocommerce-mercadopago' ); ?></span>
            </div>
            ...
            <div class="col-md-6">
              ...
              <span class="mp-error" id="mp-error-224" data-main="#securityCode"><?= esc_html__( 'This field can not be empty', 'woocommerce-mercadopago' ); ?></span>
              <span class="mp-error" id="mp-error-E302" data-main="#securityCode"><?= esc_html__( 'Invalid Security Code', 'woocommerce-mercadopago' ); ?></span>
            </div>
          </div>
              ...
              <div class="row pt-10">
                <div class="col-md-6">
                  ...
                  <div class="col-md-8 pr-25">
                    ...
                    <span class="mp-error" id="mp-error-214" data-main="#docNumber"><?= esc_html__( 'This field can not be empty', 'woocommerce-mercadopago' ); ?></span>
                    <span class="mp-error" id="mp-error-324" data-main="#docNumber"><?= esc_html__( 'Invalid Document Number', 'woocommerce-mercadopago' ); ?></span>
                  </div>
