...
require_once dirname( __FILE__ ) . '../module/preference/class-wc-mercadopago-preference-custom.php';
...
class WC_WooMercadoPago_CustomGateway extends WC_WooMercadoPago_PaymentAbstract
{
    ...
    protected function create_url($order, $custom_checkout)
    {
        ...
        $preferences = new MercadoPagoPreferenceCustom($order, $custom_checkout);;
