	...
	<div class="mp-box-inputs mp-line" id="mercadopago-form-coupon" style="margin-bottom: 16px;" >
		<div class="form-row" >
			<div class="form-col-8">
				<label for="couponCodeLabel"><?php echo esc_html__( 'Discount Coupon', 'woo-mercado-pago-module' ); ?></label>
			...
			<div class="form-col-4">
				<label >&nbsp;</label>
				<input class="form-control-mine" type="button" class="button" id="applyCoupon" value="<?php echo esc_html__( 'Apply', 'woo-mercado-pago-module' ); ?>">
			</div>
			...
			<div class="form-row" >
				<div class="form-col-8" >
					<label for="paymentMethodIdSelector">
						<?php echo esc_html__( 'Payment Method', 'woo-mercado-pago-module' ); ?><em class="obrigatorio"> *</em>
					</label>
					<select id="paymentMethodSelector" class="form-control-mine" name="mercadopago_custom[paymentMethodSelector]"
						...
						<optgroup label=<?php echo esc_html__( 'Your Card', 'woo-mercado-pago-module' ); ?> id="payment-methods-for-customer-and-cards">
						...
						<optgroup label="<?php echo esc_html__( 'Other Cards', 'woo-mercado-pago-module' ); ?>" id="payment-methods-list-other-cards">
				...
				<div class="form-col-4" id="mp-securityCode-customer-and-card">
					<label for="customer-and-card-securityCode">
						<?php echo esc_html__( 'Security code', 'woo-mercado-pago-module' ); ?><em class="obrigatorio"> *</em>
					</label>
		...
		<div id="form-ticket">
			...
			<div class="form-row" >
				<div class="form-col-12">
					<label for="cardNumber"><?php echo esc_html__( 'Credit card number', 'woo-mercado-pago-module' ); ?><em class="obrigatorio"> *</em></label>
					<input type="text" id="cardNumber" data-checkout="cardNumber"
						class="form-control-mine" autocomplete="off" maxlength="19" style="width: 100%;"/>
					<span class="mp-error" id="mp-error-205" data-main="#cardNumber"><?php echo esc_html__( 'Parameter cardNumber can not be null/empty', 'woo-mercado-pago-module' ); ?></span>
					<span class="mp-error" id="mp-error-E301" data-main="#cardNumber"><?php echo esc_html__( 'Invalid Card Number', 'woo-mercado-pago-module' ); ?></span>
				</div>
			</div>
			<!-- Expiry Date -->
			<div class="form-row" >
				<div class="form-col-6">
					<label for="cardExpirationMonth"><?php echo esc_html__( 'Expiration month', 'woo-mercado-pago-module' ); ?><em class="obrigatorio"> *</em></label>
					...
					<span class="mp-error" id="mp-error-208" data-main="#cardExpirationMonth"><?php echo esc_html__( 'Invalid Expiration Date', 'woo-mercado-pago-module' ); ?></span>
					<span class="mp-error" id="mp-error-325" data-main="#cardExpirationMonth"><?php echo esc_html__( 'Invalid Expiration Date', 'woo-mercado-pago-module' ); ?></span>
				</div>
				<div class="form-col-6">
					<label for="cardExpirationYear"><?php echo esc_html__( 'Expiration year', 'woo-mercado-pago-module' ); ?><em class="obrigatorio"> *</em></label>
			...
			<div class="form-row" >
				<div class="form-col-12">
					<label for="cardholderName"><?php echo esc_html__( 'Card holder name', 'woo-mercado-pago-module' ); ?><em class="obrigatorio"> *</em></label>
					...
					<span class="mp-error" id="mp-error-221" data-main="#cardholderName"><?php echo esc_html__( 'Parameter cardholderName can not be null/empty', 'woo-mercado-pago-module' ); ?></span>
					<span class="mp-error" id="mp-error-316" data-main="#cardholderName"><?php echo esc_html__( 'Invalid Card Holder Name', 'woo-mercado-pago-module' ); ?></span>
				</div>
			</div>
			<!-- CVV and Issuer -->
			<div class="form-row" >
				<div class="form-col-6">
					<label for="securityCode"><?php echo esc_html__( 'Security code', 'woo-mercado-pago-module' ); ?><em class="obrigatorio"> *</em></label>
					<input type="text" id="securityCode" data-checkout="securityCode" autocomplete="off" class="form-control-mine" maxlength="4"
						style="width: 100%; padding: 8px; background: url(<?php echo ($images_path . 'cvv.png'); ?>) 98% 50% no-repeat;" />
					<span class="mp-error" id="mp-error-224" data-main="#securityCode"><?php echo esc_html__( 'Parameter securityCode can not be null/empty', 'woo-mercado-pago-module' ); ?></span>
					<span class="mp-error" id="mp-error-E302" data-main="#securityCode"><?php echo esc_html__( 'Invalid Security Code', 'woo-mercado-pago-module' ); ?></span>
				</div>
				<div class="form-col-6 mp-issuer">
					<label for="issuer"><?php echo esc_html__( 'Issuer', 'woo-mercado-pago-module' ); ?><em class="obrigatorio"> *</em></label>
					<select id="issuer" data-checkout="issuer" class="form-control-mine"
						name="mercadopago_custom[issuer]" style="width: 100%;"></select>
					<span class="mp-error" id="mp-error-220" data-main="#issuer"><?php echo esc_html__( 'Parameter cardIssuerId can not be null/empty', 'woo-mercado-pago-module' ); ?></span>
				</div>
			</div>
			<!-- Document Type -->
			<div class="form-row" >
				<div class="form-col-6 mp-docType">
					<label for="docType"><?php echo esc_html__( 'Document type', 'woo-mercado-pago-module' ); ?><em class="obrigatorio"> *</em></label>
					<select id="docType" data-checkout="docType" name="mercadopago_custom[docType]"
						class="form-control-mine" style="width: 100%;"></select>
					<span class="mp-error" id="mp-error-212" data-main="#docType"><?php echo esc_html__( 'Parameter docType can not be null/empty', 'woo-mercado-pago-module' ); ?></span>
					<span class="mp-error" id="mp-error-322" data-main="#docType"><?php echo esc_html__( 'Invalid Document Type', 'woo-mercado-pago-module' ); ?></span>
				</div>
				<div class="form-col-6 mp-docNumber">
					<label for="docNumber"><?php echo esc_html__( 'Document number', 'woo-mercado-pago-module' ); ?><em class="obrigatorio"> *</em></label>
					...
					<span class="mp-error" id="mp-error-214" data-main="#docNumber"><?php echo esc_html__( 'Parameter docNumber can not be null/empty', 'woo-mercado-pago-module' ); ?></span>
					<span class="mp-error" id="mp-error-324" data-main="#docNumber"><?php echo esc_html__( 'Invalid Document Number', 'woo-mercado-pago-module' ); ?></span>
				</div>
			</div>
		</div>
	</div>
...
<script type="text/javascript">
	...
	MPv1.text.apply = "<?php echo $apply; ?>";
	MPv1.text.remove = "<?php echo $remove; ?>";
	MPv1.text.coupon_empty = "<?php echo $coupon_empty; ?>";
	MPv1.text.choose = "<?php echo $label_choose; ?>";
	MPv1.text.other_bank = "<?php echo $label_other_bank; ?>";
	MPv1.text.discount_info1 = "<?php echo $discount_info1; ?>";
	MPv1.text.discount_info2 = "<?php echo $discount_info2; ?>";
	MPv1.text.discount_info3 = "<?php echo $discount_info3; ?>";
	MPv1.text.discount_info4 = "<?php echo $discount_info4; ?>";
	MPv1.text.discount_info5 = "<?php echo $discount_info5; ?>";
	MPv1.text.discount_info6 = "<?php echo $discount_info6; ?>";
