	...
	<div class="mp-box-inputs mp-line" id="mercadopago-form-coupon" style="margin-bottom: 16px;" >
		<div class="form-row" >
			<div class="form-col-8">
				<label for="couponCodeLabel"><?php esc_html_e( 'Discount Coupon', 'woo-mercado-pago-module' ); ?></label>
			...
			<div class="form-col-4">
				<label >&nbsp;</label>
				<input class="form-control-mine" type="button" class="button" id="applyCoupon" value="<?php esc_html_e( 'Apply', 'woo-mercado-pago-module' ); ?>">
			</div>
			...
			<div class="form-row" >
				<div class="form-col-8" >
					<label for="paymentMethodIdSelector">
						<?php esc_html_e( 'Payment Method', 'woo-mercado-pago-module' ); ?><em class="obrigatorio"> *</em>
					</label>
		...
		<div id="form-ticket">
			...
			<div class="form-row" >
				<div class="form-col-12">
					<label for="cardNumber"><?php esc_html_e( 'Credit card number', 'woo-mercado-pago-module' ); ?><em class="obrigatorio"> *</em></label>
					<input type="text" id="cardNumber" data-checkout="cardNumber"
						class="form-control-mine" autocomplete="off" maxlength="19" style="width: 100%;"/>
					<span class="mp-error" id="mp-error-205" data-main="#cardNumber"><?php esc_html_e( 'Parameter cardNumber can not be null/empty', 'woo-mercado-pago-module' ); ?></span>
					<span class="mp-error" id="mp-error-E301" data-main="#cardNumber"><?php esc_html_e( 'Invalid Card Number', 'woo-mercado-pago-module' ); ?></span>
				</div>
			</div>
			<!-- Expiry Date -->
			<div class="form-row" >
				<div class="form-col-6">
					<label for="cardExpirationMonth"><?php esc_html_e( 'Expiration month', 'woo-mercado-pago-module' ); ?><em class="obrigatorio"> *</em></label>
					<select id="cardExpirationMonth" data-checkout="cardExpirationMonth" class="form-control-mine"
						...
						<option value="-1"> <?php esc_html_e( 'Month', 'woo-mercado-pago-module' ); ?> </option>
						<?php for ($x=1; $x<=12; $x++) : ?>
							<option value="<?php echo $x; ?>"> <?php echo $x; ?></option>
						<?php endfor; ?>
					</select>
					<span class="mp-error" id="mp-error-208" data-main="#cardExpirationMonth"><?php esc_html_e( 'Invalid Expiration Date', 'woo-mercado-pago-module' ); ?></span>
					<span class="mp-error" id="mp-error-325" data-main="#cardExpirationMonth"><?php esc_html_e( 'Invalid Expiration Date', 'woo-mercado-pago-module' ); ?></span>
				</div>
				<div class="form-col-6">
					<label for="cardExpirationYear"><?php esc_html_e( 'Expiration year', 'woo-mercado-pago-module' ); ?><em class="obrigatorio"> *</em></label>
					<select id="cardExpirationYear" data-checkout="cardExpirationYear" class="form-control-mine"
						...
						<option value="-1"> <?php esc_html_e( 'Year', 'woo-mercado-pago-module' ); ?> </option>
			...
			<div class="form-row" >
				<div class="form-col-12">
					<label for="cardholderName"><?php esc_html_e( 'Card holder name', 'woo-mercado-pago-module' ); ?><em class="obrigatorio"> *</em></label>
					...
					<span class="mp-error" id="mp-error-221" data-main="#cardholderName"><?php esc_html_e( 'Parameter cardholderName can not be null/empty', 'woo-mercado-pago-module' ); ?></span>
					<span class="mp-error" id="mp-error-316" data-main="#cardholderName"><?php esc_html_e( 'Invalid Card Holder Name', 'woo-mercado-pago-module' ); ?></span>
				</div>
			</div>
			<!-- CVV and Issuer -->
			<div class="form-row" >
				<div class="form-col-6">
					<label for="securityCode"><?php esc_html_e( 'Security code', 'woo-mercado-pago-module' ); ?><em class="obrigatorio"> *</em></label>
					<input type="text" id="securityCode" data-checkout="securityCode" autocomplete="off" class="form-control-mine" maxlength="4"
						style="width: 100%; padding: 8px; background: url(<?php echo ($images_path . 'cvv.png'); ?>) 98% 50% no-repeat;" />
					<span class="mp-error" id="mp-error-224" data-main="#securityCode"><?php esc_html_e( 'Parameter securityCode can not be null/empty', 'woo-mercado-pago-module' ); ?></span>
					<span class="mp-error" id="mp-error-E302" data-main="#securityCode"><?php esc_html_e( 'Invalid Security Code', 'woo-mercado-pago-module' ); ?></span>
				</div>
				<div class="form-col-6 mp-issuer">
					<label for="issuer"><?php esc_html_e( 'Issuer', 'woo-mercado-pago-module' ); ?><em class="obrigatorio"> *</em></label>
					<select id="issuer" data-checkout="issuer" class="form-control-mine"
						name="mercadopago_custom[issuer]" style="width: 100%;"></select>
					<span class="mp-error" id="mp-error-220" data-main="#issuer"><?php esc_html_e( 'Parameter cardIssuerId can not be null/empty', 'woo-mercado-pago-module' ); ?></span>
				</div>
			</div>
			<!-- Document Type -->
			<div class="form-row" >
				<div class="form-col-6 mp-docType">
					<label for="docType"><?php esc_html_e( 'Document type', 'woo-mercado-pago-module' ); ?><em class="obrigatorio"> *</em></label>
					<select id="docType" data-checkout="docType" name="mercadopago_custom[docType]"
						class="form-control-mine" style="width: 100%;"></select>
					<span class="mp-error" id="mp-error-212" data-main="#docType"><?php esc_html_e( 'Parameter docType can not be null/empty', 'woo-mercado-pago-module' ); ?></span>
					<span class="mp-error" id="mp-error-322" data-main="#docType"><?php esc_html_e( 'Invalid Document Type', 'woo-mercado-pago-module' ); ?></span>
				</div>
				<div class="form-col-6 mp-docNumber">
					<label for="docNumber"><?php esc_html_e( 'Document number', 'woo-mercado-pago-module' ); ?><em class="obrigatorio"> *</em></label>
					...
					<span class="mp-error" id="mp-error-214" data-main="#docNumber"><?php esc_html_e( 'Parameter docNumber can not be null/empty', 'woo-mercado-pago-module' ); ?></span>
					<span class="mp-error" id="mp-error-324" data-main="#docNumber"><?php esc_html_e( 'Invalid Document Number', 'woo-mercado-pago-module' ); ?></span>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="form-row" >
				<div id="mp-box-installments-selector" class="form-col-8">
					<label for="installments">
						<?php esc_html_e( 'Installments', 'woo-mercado-pago-module' ); ?>
