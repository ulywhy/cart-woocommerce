window.onload = function () {
  ...
  document.getElementById("mp_table_13").append(cloneSaveButton.cloneNode(true));
  document.getElementById("mp_table_14").append(cloneSaveButton.cloneNode(true));
  ...
  var collapse_table = document.querySelector("#mp_table_14");
  ...
  var collapse_table_2 = document.querySelector("#mp_table_18");
  ...
  //payment methods
  var input_payments = document.querySelectorAll('#mp_table_17 td.forminp label');
